...
class CourseClass:
    def __init__(self,root):
        ...
        #===title===#
        title=Label(self.root,text="Manage Course Details",font=("goudy old style",20,"bold"),bg="#033054",fg="white").place(x=10,y=15,width=1350,height=40)
        ...
        #===EntryFields===
        self.txt_courseName=Entry(self.root,textvariable=self.var_course,font=("goudy old style",15,'bold'),bg='lightpink')
        ...
        self.txt_description=Text(self.root,font=("goudy old style",15,'bold'),bg='lightpink')
        ...
        txt_search_courseName=Entry(self.root,textvariable=self.var_search,font=("goudy old style",15,'bold'),bg='lightpink').place(x=970,y=60,width=180)
